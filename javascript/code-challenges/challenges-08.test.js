...
const citiesAtoJ = (arr) => arr.filter((str) => str.match(/^[A-J]\w*\b/g));
...
describe('Testing challenge 6', () => {
  ...
  test('It should return the cities whose names begin with the letters A through J', () => {
    ...
    expect(citiesAtoJ(['Albuquerque', 'Chicago', 'Philadelphia', 'Newark', 'Sacramento', 'Eugene'])).toEqual(
      expect.arrayContaining(['Albuquerque', 'Chicago', 'Eugene'])
    );
  });
...
xdescribe('Testing challenge 9', () => {
  ...
  test('It should remove the vowels from the hangman string and replace them with underscores', () => {
    ...
    expect(hangman('I wAnt them all tO bE removed and replaced with Underscores.')).toStrictEqual(
